...
const footerLinks = {
  product: {
    ...
    links: [
      ...
      { href: "/risk", label: "Risk Workspace" },
    ],
  },
  resources: {
    title: "Resources",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 lg:py-16 grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Portfolio risk analytics UI for serious investors, analysts, and students.
            </p>
          </div>
        ...
        <div className="py-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            {new Date().getFullYear()} Portfolio Risk Analysis. All rights reserved.
          </p>
